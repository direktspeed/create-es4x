// TODO: Handle npm init
// TODO: Handle Chromitex install
// TODO: Handle GraalVM Install
// Else default https://unpkg.com/browse/@es4x/create@0.18.0/
const {existsSync} = require('fs');
const path = require('path');
const {spawn, spawnSync} = require('child_process');

let java = 'java';
let pm = 'es4x-pm-0.18.0.jar';
